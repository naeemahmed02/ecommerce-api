...
class Order(models.Model):
    ...
    adress_line_one = models.CharField(max_length=200)
    adress_line_two = models.CharField(max_length=200)
...
class OrderProduct(models.Model):
    ...
    variation = models.ForeignKey(ProductVariations, on_delete=models.CASCADE)
